...
function RepoGitPanel({ repo, isExpanded, onToggle }) {
  ...
  return (
    <div className="border-b border-vscode-border">
      <div
        className="w-full px-3 py-2.5 flex items-center justify-between hover:bg-vscode-sidebar-hover"
      >
        <div className="min-w-0 flex items-center gap-1.5">
          <button
            onClick={onToggle}
            className="text-vscode-text-muted hover:text-vscode-text shrink-0"
            style={{ background: 'none', border: 'none', outline: 'none' }}
          ...
          <button
            onClick={onToggle}
            className="text-sm text-vscode-text hover:text-white truncate shrink-0"
            style={{ background: 'none', border: 'none', outline: 'none' }}
            title={isExpanded ? 'Collapse repo' : 'Expand repo'}
          >
            {repo.name}
